...
// MARK: Toast
public enum Toast {
    public static var configuration: ConfigurationToastProtocol = {
        let configuration: ConfigurationToastProtocol? = Injector.main.resolveOrDefault("FormsToastKit")
        return configuration ?? Configuration.Toast()
    }()
