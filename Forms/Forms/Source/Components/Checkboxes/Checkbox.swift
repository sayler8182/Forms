...
// MARK: Checkbox
open class Checkbox: FormsComponent, FormsComponentWithMarginEdgeInset, FormsComponentWithPaddingEdgeInset {
    ...
    open var updateGroupKey: String? = nil
    ...
    open func updateGroup() {
        self.table?.views
            ...
            .filter { $0.updateGroupKey.isNotNil }
            .filter { $0.updateGroupKey == self.updateGroupKey }
            .filter { $0 !== self }
...
public extension Checkbox {
    ...
    func with(updateGroupKey: String?) -> Self {
        self.updateGroupKey = updateGroupKey
        return self
    }
