...
extension ScrollContainer: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
...
// MARK: ScrollContainerFlowLayout
private class ScrollContainerFlowLayout: UICollectionViewFlowLayout {
    override init() {
        super.init()
