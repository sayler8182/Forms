...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Transition",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@protocol UIViewControllerContextTransitioning;

SWIFT_CLASS("_TtC10Transition18TransitionAnimator")
...
SWIFT_CLASS("_TtC10Transition21TransitionCoordinator")
@interface TransitionCoordinator : NSObject <UINavigationControllerDelegate>
...
SWIFT_CLASS("_TtC10Transition30TransitionNavigationController")
@interface TransitionNavigationController : UINavigationController
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
