...
- (nonnull instancetype)withOrigin:(CGPoint)origin SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)withSize:(CGSize)size SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)withWidth:(CGFloat)width SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)withWidth:(CGFloat)width height:(CGFloat)height SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)withShadowWithColor:(UIColor * _Nonnull)color opacity:(float)opacity offset:(CGSize)offset radius:(CGFloat)radius cornerRadius:(CGFloat)cornerRadius scale:(BOOL)scale rasterize:(BOOL)rasterize masksToBounds:(BOOL)masksToBounds SWIFT_WARN_UNUSED_RESULT;
@end
...
@interface UIViewController (SWIFT_EXTENSION(Utils))
